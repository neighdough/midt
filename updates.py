...
This module contains two methods to extract data from Shelby County Register
of Deeds site. It is only intended to be used to scrape recent and comparable

'''
#from aptdaemon.config import __author__
#from httplib2.iri2uri import __copyright__
...
import getopt
import json
from sqlalchemy import create_engine, MetaData, Table, Column, Sequence
...
def scrape_register(startdate, enddate='', instype = 'ALL'):
...
def update_ce_tables(file_path):
    """
